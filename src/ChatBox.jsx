...
const chat = model.startChat({
  ...
  systemInstruction: {
    ...
    parts: [{
      text: `
      You are Emul 🐿️ — a loyal, playful AI assistant created by Badhon Biswas.
      Help with coding, tasks, real-time info, and cheer Badhon on! 💻✨
      `,
    }],
  },
});
...
function ChatBox() {
  ...
  const needsSearch = (text) => {
    ...
    return ["latest", "today", "who won", "score", "current", "news", "real time"].some(word =>
      lower.includes(word)
    );
  };
        ...
        <div className="chat-messages">
          ...
          {isTyping && (
            <div className="chat-message bot">
              <img src={avatar.bot} alt="Bot" className="avatar" />
              <div className="message-text typing">🤖 Emul is typing...</div>
            </div>
          )}
